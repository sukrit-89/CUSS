...
export function HeroPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white flex flex-col">
      ...
      {/* ---------------------------------------------------- */}
      {/* RED MANIFESTO SECTION WITH VIDEO BLEND               */}
      {/* ---------------------------------------------------- */}
      <section className="relative min-h-screen w-full bg-[#FF0000] flex flex-col z-10">
        <div className="flex-1 flex flex-col items-center w-full pt-[100px] md:pt-[400px]">
          <div className="flex flex-col items-center w-full px-8 text-center z-20 relative max-w-[900px] h-auto md:h-[620px] mx-auto">
            ...
            {/* Mission statement */}
            <p className="font-manrope text-white text-[16px] h-[100px] w-full max-w-[400px] leading-[1.6] mb-[40px] uppercase tracking-wider mx-auto">
            ...
            {/* Two paragraphs */}
            <div className="font-manrope text-white leading-[1.6] mb-[100px] md:mb-24 w-full flex flex-col items-center font-light">
