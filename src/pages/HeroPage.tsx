        ...
        <div className="flex-1 flex flex-col items-center w-full pt-[100px] md:pt-[400px]">
          ...
          >
            ...
            <motion.p
              ...
              className="font-manrope text-white text-[16px] h-[100px] w-full max-w-[400px] leading-[1.6] mb-[40px] uppercase tracking-wider mx-auto"
            >
            ...
            <motion.div
              ...
              className="font-manrope text-white leading-[1.6] mb-[100px] md:mb-24 w-full flex flex-col items-center font-light"
            >
